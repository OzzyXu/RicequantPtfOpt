...
def black_litterman_prep(order_book_ids, start_date, investors_views, investors_views_indicate_M,
                         ...
                         confidence_of_views=None, window=None):
    """
    ...
    :param window: int. Interval length of sample; Default: 132;
    ...
    clean_period_prices, reset_start_date = (data_process(order_book_ids, asset_type, start_date, window)[i]
                                             for i in [0, 2])
