...
def get_optimizer(order_book_ids, start_date, asset_type, method, tr_frequency = 66, current_weight=None, bnds=None,
    ...
    """
    Wrap ptfopt0.py to run optimizer and get indicators
    ...
    :param method: str. Portfolio optimization model: "risk_parity", "min_variance", "mean_variance",
                        "risk_parity_with_cons", "all"("all" method only contains "risk_parity", "min_variance",
                        "risk_parity_with_cons" but not "mean_variance");
...
def get_efficient_plots(fund_test_suite, bigboss):
    ...
    :return:
    """
    annualized_vol = {'equal_weight': [], 'min_variance': [], 'risk_parity': [], "risk_parity_with_cons": []}
    annualized_return = {'equal_weight': [], 'min_variance': [], 'risk_parity': [], "risk_parity_with_cons": []}


    for j in ['equal_weight', 'min_variance', 'risk_parity', "risk_parity_with_cons"]:
